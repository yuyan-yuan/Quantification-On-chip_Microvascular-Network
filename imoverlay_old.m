function out = imoverlay_old(in, mask, color)
%IMOVERLAY_OLD Create a mask-based image overlay.
%   This function has been superseded by the Image Processing Toolbox
%   function IMOVERLAY, which shipped with R2016a.
%
%   OUT = IMOVERLAY_OLD(IN, MASK, COLOR) takes an input image, IN, and a
%   binary image, MASK, and produces an output image whose pixels in the
%   MASK locations have the specified COLOR.
%
...
%       I = peaks;
%       mask = I > 7;
%       rgb = IMOVERLAY_OLD(mat2gray(I), mask, [1 0 0]);
